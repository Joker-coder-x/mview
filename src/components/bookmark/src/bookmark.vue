...
export default {
    ...
    methods:{
        ...
        getBeforeSize(){
            let size=12;
            if(this.position==positionList[0]||this.position==positionList[1]){
                size=this.curWarpHeight;
            }else if(this.position==positionList[2]||this.position==positionList[3]){
